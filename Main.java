...
public class Main {
    ...
    public static void acessarSistemaRestaurante() {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    fecharPedido(pedidos, mesaFechar);
                    break;
                case 3:
    ...
    // Função para adicionar mesas ao restaurante
    ...
    // Função para buscar uma mesa pelo número (não depende de disponibilidade)
    ...
    // Função para buscar uma mesa que esteja disponível (não ocupada e não reservada)
    ...
    public static void fecharPedido(ArrayList<Pedido> pedidos, int numeroMesa) {
        for (Pedido pedido : pedidos) {
            if (pedido.mesa.getNumero() == numeroMesa && !pedido.finalizado) {
                pedido.fecharPedido();
                pedido.mesa.setDisponivel(true); // Libera a mesa
                pedido.mesa.setReservada(false); // Remove a reserva
